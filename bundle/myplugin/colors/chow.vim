...
" Under GUI
highlight Normal guifg=gray90 guibg=gray17 gui=none
highlight SignColumn guifg=gray guibg=gray17 gui=none
highlight Cursor guifg=black guibg=lightyellow gui=none
...
highlight Pmenu guifg=white guibg=gray30 gui=none
highlight PmenuSel guifg=lightsalmon guibg=gray17 gui=italic
highlight Question guifg=springgreen gui=none
highlight Search guifg=palegreen guibg=gray30 gui=italic
...
highlight Comment guifg=skyblue gui=italic
highlight Constant guifg=#e07070 gui=italic
highlight Identifier guifg=skyblue gui=none
highlight Function guifg=palegreen3 gui=none
highlight Statement guifg=#fcd38d gui=bold
highlight PreProc guifg=palevioletred2 gui=none
highlight Type guifg=khaki gui=bold
...
highlight Todo guifg=black guibg=#fcd38a gui=italic
